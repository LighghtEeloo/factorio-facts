...
Layout recipe rows should stay task-focused: show recipe identity, craft time, production size, remove, and reorder controls, but avoid category pills because categories are scan noise in this editor.
