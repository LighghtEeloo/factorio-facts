...
- Installed: installed layout snapshots appear as composite recipes that can be added to the focused layout, opened as immutable read-only layouts in the layout editor view, and unloaded only when no layout or installed snapshot references them.
